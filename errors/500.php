...
<body>
    <div class="container">
        <div class="error-container">
            ...
            <div class="alert alert-light d-inline-block text-dark">
            ...
            <div class="mt-4">
                ...
                <a href="javascript:location.reload()" class="btn btn-home ms-3">
            ...
            <div class="mt-5">
                <p class="small">
                    <a href="/const/contact.php" class="text-white text-decoration-none">
                        <i class="fas fa-envelope me-2"></i> Report This Issue
                    </a>
                </p>
            </div>
        </div>
